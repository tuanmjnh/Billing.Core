...
namespace Billing.Core.Controllers {
    ...
    public class MyTVController : BaseController {
        ...
        public JsonResult UpdateContact(Common.DefaultObj obj) {
            ...
            try {
                ...
                //    var MyTV = _Con.Connection.Query<Models.MYTV>(qry);
                //    //Get DB PTTB
                ...
                var data = _Con.Connection.Query<Models.MYTV>(qry);
                //Get DB PTTB
                qry = "SELECT * FROM DANH_BA_MYTV";
                var dbpttb = HNIVNPTBACKAN1.Connection.Query<Models.DANH_BA_MYTV>(qry).ToList();
                //
                ...
                //
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Cập nhật: {DataUpdate.Count} - Thêm mới: {DataInsert.Count}" });
        ...
        public JsonResult UpdateContactNULL(Common.DefaultObj obj) {
            ...
            try {
                ...
                var dbpttb_kh = HNIVNPTBACKAN1.Connection.Query<Models.DANH_BA_MYTV>(qry).ToList();
                ...
                var dbpttb_dvi = HNIVNPTBACKAN1.Connection.Query<Models.DANH_BA_MYTV>(qry).ToList();
                ...
                foreach (var i in data) {
                    ...
                    if (db != null) {
                        i.ISNULL = 2;
                        i.MA_DVI = db.MA_DVI;
                        if (i.MA_TUYEN == null || TM.Core.Regex.RegEx.isNumber(i.MA_TUYEN)) i.MA_TUYEN = $"T{db.MA_ST}000";
                    }
        ...
        public JsonResult UpdateData(Common.DefaultObj obj) {
            ...
            try {
                ...
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Cập nhật dữ liệu thành công" });
        ...
        public JsonResult XuLyTichHop(Common.DefaultObj obj) {
            ...
            try {
                ...
                _Con.Connection.Query(qry);
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Cập nhật tích hợp thành công!" });
            } catch (Exception ex) { return Json(new { danger = ex.Message + " - Index: " + index }); }
        }
        ...
        public JsonResult XuLyKhuyenMai(Common.DefaultObj obj) {
            ...
            try {
                ...
                _Con.Connection.Query(qry);
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Cập nhật khuyến mại thành công!" });
            } catch (Exception ex) { return Json(new { danger = ex.Message + " - Index: " + index }); }
        }
        ...
        public JsonResult XuLyManu(Common.DefaultObj obj) {
            ...
            try {
                ...
                _Con.Connection.Query(qry);
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Cập nhật thuê bao Manu thành công!" });
            } catch (Exception ex) { return Json(new { danger = ex.Message + " - Index: " + index }); }
        }
        ...
        public JsonResult XuLyThanhToanTruoc(Common.DefaultObj obj) {
            ...
            try {
                ...
                _Con.Connection.Query(qry);
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Cập nhật thanh toán trước thành công!" });
            } catch (Exception ex) { return Json(new { danger = ex.Message + " - Index: " + index }); }
        }
        ...
        public JsonResult XuLyThanhToanTruocFix(Common.DefaultObj obj) {
            ...
            try {
                ...
                _Con.Connection.Query(qry, null, null, true, 3000);
                ...
                _Con.Connection.Query(qry);
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Cập nhật thanh toán trước fix thành công!" });
            } catch (Exception ex) { return Json(new { danger = ex.Message + " - Index: " + index }); }
        }
        ...
        public JsonResult XuLyDatCoc(Common.DefaultObj obj) {
            ...
            try {
                ...
                _Con.Connection.Query(qry);
                return Json(new { success = $"{Common.Objects.TYPE_HD.HD_MYTV} - Xử lý đặt cọc thành công!" });
            } catch (Exception ex) { return Json(new { danger = ex.Message + " - Index: " + index }); }
        }
    ...
    //    DataAccess.Connection._Con _Con = new DataAccess.Connection._Con();
    //    public ActionResult Index()
    //    {
    //        try
    //        {
    ...
    //                i.TIME_BILL = obj.datetime;
    //            }
    //            _Con.Connection.Insert(data.Trim());
    //            this.success("Cập nhật file cước thành công!");
    //        }
    //        catch (Exception ex) { this.danger(ex.Message + " - Index: " + index); }
    //        return RedirectToAction("Index");
